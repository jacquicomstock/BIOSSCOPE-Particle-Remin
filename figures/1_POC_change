...
# ----------------------------
# Filter to T0 and summarize C (uM)
# ----------------------------
df_t0 = df[df["Timepoint"] == "T0"].copy()

summ = (
    df_t0.groupby(["Experiment", "Water_Amendment_Abr"], as_index=False)["C (uM)"]
    .agg(mean="mean", sd="std")
)

# ----------------------------
# Parse treatment labels + colors (same scheme as before)
# ----------------------------
...
plt.ylabel("C (uM) at T0")
plt.tight_layout()

png_path = "/mnt/data/POM_C_uM_T0_highres.png"
...
# ----------------------------
pdf_path = "/mnt/data/POM_C_uM_T0_high_quality.pdf"
