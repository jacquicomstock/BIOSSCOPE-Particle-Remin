...
# Change in N(uM): TF - T0
rep_tbl["N_change"] = rep_tbl["TF"] - rep_tbl["T0"]

# Mean + SD of the change for each Experiment × Water_Amendment_Abr
summ = (
    rep_tbl.groupby(["Experiment", "Water_Amendment_Abr"], as_index=False)["N_change"]
...
plt.ylabel("Change in N (uM) (TF - T0)")
plt.tight_layout()

png_path = "/mnt/data/POM_N_change_highres.png"
...
# ----------------------------
pdf_path = "/mnt/data/POM_N_change_high_quality.pdf"
