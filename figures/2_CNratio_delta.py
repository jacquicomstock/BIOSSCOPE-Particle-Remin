...
# Load dataset
# ----------------------------
file_path = "C:/Users/jacqu/Desktop/Research/Projects/BIOSSCOPE/Particle_Experiments/Manuscript Figures/POM_PR_PR2_PR3.csv"
df = pd.read_csv(file_path)

# ----------------------------
# Create a replicate index within each Experiment × Treatment × Timepoint
# (dataset does not have an explicit replicate column)
# ----------------------------
...
# Change in C/N (molar): TF - T0
rep_tbl["CN_change"] = rep_tbl["TF"] - rep_tbl["T0"]

# Mean + SD of the change for each Experiment × Water_Amendment_Abr
summ = (
    rep_tbl.groupby(["Experiment", "Water_Amendment_Abr"], as_index=False)["CN_change"]
...
plt.ylabel("Change in C/N (molar) (TF - T0)")
plt.tight_layout()

png_path = "/mnt/data/POM_CN_change_highres.png"
...
# ----------------------------
pdf_path = "/mnt/data/POM_CN_change_high_quality.pdf"
