...
# Load dataset
# ----------------------------
file_path = "/mnt/data/POM_PR_PR2_PR3.csv"
df = pd.read_csv(file_path)

# ----------------------------
# Filter to T0 and summarize N (uM)
# ----------------------------
df_t0 = df[df["Timepoint"] == "T0"].copy()

summ = (
    df_t0.groupby(["Experiment", "Water_Amendment_Abr"], as_index=False)["N (uM)"]
...
plt.ylabel("N (uM) at T0")
plt.tight_layout()

png_path = "/mnt/data/POM_N_uM_T0_highres.png"
...
# Embed PNG into PDF
# ----------------------------
pdf_path = "/mnt/data/POM_N_uM_T0_high_quality.pdf"
